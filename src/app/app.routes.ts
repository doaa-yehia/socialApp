...
export const routes: Routes = [
    ...
    {path:"changePassword",loadComponent: ()=> import('./pages/change-password/change-password.component').then ( c => c.ChangePasswordComponent), title:'change Password',canActivate:[authGuard]},
